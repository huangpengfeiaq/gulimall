package com.hpf.gulimall.cart.service.impl;
...
import com.hpf.gulimall.cart.to.UserInfoTo;
import com.hpf.gulimall.cart.vo.CartItemVo;
import com.hpf.gulimall.cart.vo.CartVo;
import com.hpf.gulimall.cart.vo.SkuInfoVo;
    ...
    public CartItemVo addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            CompletableFuture<Void> getSkuInfoFuture = CompletableFuture.runAsync(() -> {
                ...
                SkuInfoVo skuInfo = productSkuInfo.getKey("skuInfo", new TypeReference<SkuInfoVo>() {});
                //数据赋值操作
