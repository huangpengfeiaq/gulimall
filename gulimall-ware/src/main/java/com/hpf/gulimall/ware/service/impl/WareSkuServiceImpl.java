...
import com.hpf.common.to.mq.StockDetailTo;
...
import com.hpf.gulimall.ware.entity.WareOrderTaskDetailEntity;
import com.hpf.gulimall.ware.entity.WareOrderTaskEntity;
import com.hpf.gulimall.ware.service.WareOrderTaskDetailService;
import com.hpf.gulimall.ware.service.WareOrderTaskService;
import com.hpf.gulimall.ware.vo.OrderVo;
import lombok.Data;
    ...
    public void unlockStock(StockLockedTo to) {
        ...
        if (taskDetailInfo != null) {
            ...
            if (orderData.getCode() == 0) {
                //订单数据返回成功
                OrderVo orderInfo = orderData.getKey("data", new TypeReference<OrderVo>() {
                });
