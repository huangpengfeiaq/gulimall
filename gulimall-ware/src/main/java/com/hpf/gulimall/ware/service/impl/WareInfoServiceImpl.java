...
import com.hpf.gulimall.ware.dao.WareInfoDao;
import com.hpf.gulimall.ware.entity.WareInfoEntity;
import com.hpf.gulimall.ware.service.WareInfoService;
...
public class WareInfoServiceImpl extends ServiceImpl<WareInfoDao, WareInfoEntity> implements WareInfoService {
    ...
    public FareVo getFare(Long addrId) {
        ...
        MemberAddressVo memberAddressVo = addrInfo.getKey("memberReceiveAddress",new TypeReference<MemberAddressVo>() {});
