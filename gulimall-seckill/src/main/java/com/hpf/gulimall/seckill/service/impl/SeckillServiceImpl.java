package com.hpf.gulimall.seckill.service.impl;
...
import com.hpf.common.vo.MemberResponseVo;
import com.hpf.feign.client.CouponFeignClient;
import com.hpf.feign.client.ProductFeignClient;
import com.hpf.gulimall.seckill.interceptor.LoginUserInterceptor;
import com.hpf.gulimall.seckill.service.SeckillService;
import com.hpf.gulimall.seckill.to.SeckillSkuRedisTo;
import com.hpf.gulimall.seckill.vo.SeckillSessionWithSkusVo;
import com.hpf.gulimall.seckill.vo.SkuInfoVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void uploadSeckillSkuLatest3Days() {
        ...
        if (lates3DaySession.getCode() == 0) {
            //上架商品
            List<SeckillSessionWithSkusVo> sessionData = lates3DaySession.getKey("data", new TypeReference<List<SeckillSessionWithSkusVo>>() {
            });
            //缓存到Redis
            //1、缓存活动信息
        ...
        sessions.stream().forEach(session -> {
            ...
            session.getRelationSkus().stream().forEach(seckillSkuVo -> {
                ...
                if (!operations.hasKey(redisKey)) {
                    ...
                    if (info.getCode() == 0) {
                        SkuInfoVo skuInfo = info.getKey("skuInfo", new TypeReference<SkuInfoVo>() {
                        });
