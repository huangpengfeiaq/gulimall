...
@EnableFeignClients(basePackages = {"com.hpf.gulimall.feign.client"})
@EnableDiscoveryClient
@MapperScan("com.hpf.gulimall.product.dao")
@SpringBootApplication(scanBasePackages = {"com.hpf.gulimall.product", "com.hpf.gulimall.feign.fallback"})
